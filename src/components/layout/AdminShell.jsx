...
const AdminShell = () => {
  ...
  const navItems = useMemo(() => {
    const initial = [
      ...
      ...(isDeveloper ? [{ to: '/admin/purchase-history', label: 'Purchase History', icon: FaDollarSign }] : []),
      ...(isDeveloper ? [{ to: '/admin/access-grant-history', label: 'Access Grants', icon: FaHistory }] : []),
      ...(isDeveloper ? [{ to: '/admin/permission-verification', label: 'Permission Verification', icon: FaUsers }] : []),
