...
const paymentTransactionSchema = new mongoose.Schema(
  {
    ...
    purpose_type: { type: String, enum: ['subscription', 'material_access', 'center_access', 'tutorship_booking'], required: true, index: true },
    purpose_code: { type: String, required: true, trim: true, index: true },
    resource_type: { type: String, enum: ['subscription', 'report', 'presentation', 'question_paper', 'chat_room', 'chat_invite', 'lecturer_booking'], default: 'subscription', index: true },
